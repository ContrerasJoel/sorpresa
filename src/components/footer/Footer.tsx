    ...
    <div className="footer__container">
      <div className="footer__sections">
        ...
        <div className="footer__sections_contacts">
          ...
          <div>
            <Link
              href="https://api.whatsapp.com/send?phone=+573194921133&text=Hola!"
              target="_blank"
            >
            ...
            <Link
              href="https://www.instagram.com/mente.intima/"
              target="_blank"
            >
      ...
      <div className="footer__copyright">
        <Link href="https://www.linkedin.com/in/joel-contreras-fullstack/">
          © 2020. Página creada por Joel Contreras. Todos los derechos
          reservados.
        </Link>
      </div>
    </div>
